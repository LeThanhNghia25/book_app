              ...
              if (snapshot.connectionState == ConnectionState.waiting) {
                ...
                return SliverGrid(
                  delegate: SliverChildBuilderDelegate(
                      ...
                      return GestureDetector(
                        onTap: () {
                          // Tạo một đối tượng Book từ dữ liệu của Google API
                          final trendingBook = Book(
                            name: book['title'],
                            category: book['categories']?.first ?? 'Unknown',
                            image: googleBooksAPI.getBookCover(book),
                          );
                          ...
                          // Điều hướng đến màn hình BookDetails
                          Navigator.push(
                            context,
                            MaterialPageRoute(
                                builder: (context) =>  BookDetails()),
