                              ...
                              children: [
                                ...
                                IconButton(
                                  onPressed: () async {
                                    ...
                                    if (user == null) {
                                      print('Error: User not ');
                                      ScaffoldMessenger.of(context).showSnackBar(
                                        SnackBar(content: Text('Bạn cần đăng nhập để thực hiện thao tác này!')),
                                      );
                                    ...
                                    try {
                                      ...
                                      // Cập nhật lại danh sách sách đã lưu sau khi thao tác
                                      ref.refresh(fetchSavedBooksProvider);
                                    } catch (e) {
